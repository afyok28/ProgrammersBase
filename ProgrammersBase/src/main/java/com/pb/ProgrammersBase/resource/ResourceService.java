...
public class ResourceService {
    ...
    public List<Resource> findByTitleContaining(String keyword, Long categoryCode) {

        return resourceRepository.findByCategoryCodeAndTitleContainingIgnoreCaseOrCategoryCodeAndDescContainingIgnoreCase(
                categoryCode, keyword, categoryCode, keyword
        );
    }

    public Page<Resource> findPaginated(int pageNum, int pageSize, String sortField, String sortDirection, Long categoryCode) {
        ...
        return this.resourceRepository.findByCategoryCode(categoryCode, pageable);
    }
}
